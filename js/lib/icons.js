...
const P = {
  ...
  /* ⚠️ كانت مفقودة: `pages.js` و`home-employee.js` يطلبان 'megaphone' منذ
     المرحلة ١١، و`icon()` ترجع نصّاً فارغاً للاسم المجهول بلا ضجيج — فبقيت
     «الإعلانات» وحدها بلا أيقونة في قائمة كل الأدوار ولم يشتكِ شيء. */
  megaphone: '<path d="M4.5 9.5H7l9-4.5v14l-9-4.5H4.5a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2Z"/><path d="M7 14.5V19a1.6 1.6 0 0 0 3.2 0v-3.4"/><path d="M19 9.6a3.2 3.2 0 0 1 0 4.8"/>',
