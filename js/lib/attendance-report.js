...
export function attendanceReportRow(day) {
  ...
  return {
    ...
    deductibleLateMinutes: presentation.deductibleLateMinutes,
    uncoveredEarlyMinutes: presentation.uncoveredEarlyMinutes,
    uncoveredMidMinutes: presentation.uncoveredMidMinutes,
