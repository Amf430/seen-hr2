...
export const PAGES = {
  ...
  'my-day':      { title: 'يومي',                   hint: 'مهام اخترتها ليومك وقائمتك الشخصية' },
...
export const NAV_GROUPS = [
  ...
  { group: '', items: [
    ...
    /* ⚠️ «يومي» بجوار «مهامي» لا في مجموعة أخرى: الموظف ينتقل بينهما في
       الدقيقة الواحدة — يفتح مهامه فيختار منها ليومه. وهي للأدمن أيضاً:
       القائمة الشخصية لا علاقة لها بالدور. */
    { id: 'my-day', icon: 'list', label: 'يومي', roles: ['employee', 'manager', 'admin'] },
